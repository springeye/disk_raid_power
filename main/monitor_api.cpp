...
void updateUI() {
    ...
    if (data.portC1.isCharging)
        data.totalInPower += data.portC1.power;
    if (data.portC2.isCharging)
        data.totalInPower += data.portC2.power;
    if (data.portC1.isDischarging)
        data.totalOutPower += data.portC1.power;
    if (data.portC2.isDischarging)
        data.totalOutPower += data.portC2.power;
