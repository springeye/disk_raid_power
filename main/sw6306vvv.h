...
//外部库给出的I2C读写函数
    ...
    #define SW6306_I2C_Transmit(addr,reg,pdata,len,pflag)   SW6306_Arduino_I2C_Transmit(addr,reg,pdata,len,pflag)
    #define SW6306_I2C_Receive(addr,reg,pdata,len,pflag)    SW6306_Arduino_I2C_Receive(addr,reg,pdata,len,pflag)
#else//不允许挂起
